...
const currentAreaId = ref(undefined)
...
//当前城市
const getCurrent = () => {
  return getCurrentCity().then(response => {
...
onMounted(async () => {
  ...
  pageParams.value.areaId = currentAreaId.value
  recommendParams.areaId = currentAreaId.value
  pageParams.value.timeType = timeType.value
