...
- Redis `16379 -> 6379`
- Nacos `18848 -> 8848`
- RabbitMQ `5672 -> 5672`，管理端 `15672 -> 15672`
...
$env:DAMAI_RABBITMQ_AMQP_PORT = "5672"
$env:DAMAI_RABBITMQ_PORT = "15672"
$env:DAMAI_ES_PORT = "19200"
$env:DAMAI_MYSQL_HOST = "127.0.0.1"
$env:DAMAI_NACOS_ADDR = "127.0.0.1:18848"
$env:DAMAI_REDIS_HOST = "127.0.0.1"
$env:DAMAI_RABBITMQ_HOST = "127.0.0.1"
$env:DAMAI_RABBITMQ_USERNAME = "damai"
$env:DAMAI_RABBITMQ_PASSWORD = "damai"
