...
public class DaMaiConstant {
    ...
    public static final String ORDER_LIST_ADDRESS = resolveEnv("DAMAI_AI_ORDER_LIST_ADDRESS", "http://127.0.0.1:5173/orderManagement/index");

    public static final String PROGRAM_DETAIL_URL = resolveEnv("DAMAI_AI_PROGRAM_DETAIL_URL", "http://127.0.0.1:6085/damai/program/program/detail");
