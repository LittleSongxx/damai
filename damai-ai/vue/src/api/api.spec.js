import { aiOpsAdminAPI, createAbsoluteUrl, createSseIterator, customerServiceAPI, dataOpsAdminAPI, evaluationCenterAPI, getAuthState, parseSseChunk, promptVersionAPI, ragEvalAPI } from './api'
...
describe('api sse helpers', () => {
  ...
  it('calls RAG eval, AIOps, and prompt governance endpoints', async () => {
    ...
    await evaluationCenterAPI.createRun({ domain: 'PURCHASE_AGENT', sampleMode: 'SMOKE' })
    await evaluationCenterAPI.getRun('purchase-eval-1')
    await evaluationCenterAPI.getRunResults('purchase-eval-1')
    await evaluationCenterAPI.getDashboard()
    await evaluationCenterAPI.replayFailed('purchase-eval-1')
    ...
    expect(fetchMock.mock.calls[6][0].toString()).toContain('/assistant/admin/evals/runs')
    expect(fetchMock.mock.calls[6][1].method).toBe('POST')
    expect(JSON.parse(fetchMock.mock.calls[6][1].body)).toEqual({ domain: 'PURCHASE_AGENT', sampleMode: 'SMOKE' })
    expect(fetchMock.mock.calls[7][0].toString()).toContain('/assistant/admin/evals/runs/purchase-eval-1')
    expect(fetchMock.mock.calls[8][0].toString()).toContain('/assistant/admin/evals/runs/purchase-eval-1/results')
    expect(fetchMock.mock.calls[9][0].toString()).toContain('/assistant/admin/evals/dashboard')
    expect(fetchMock.mock.calls[10][0].toString()).toContain('/assistant/admin/evals/runs/purchase-eval-1/replay-failed')
    expect(fetchMock.mock.calls[10][1].method).toBe('POST')
    expect(fetchMock.mock.calls[11][0].toString()).toContain('/assistant/admin/ops/providers')
    expect(fetchMock.mock.calls[12][0].toString()).toContain('/assistant/admin/ops/runbooks')
    expect(fetchMock.mock.calls[13][0].toString()).toContain('/assistant/admin/ops/rca-evidence')
    expect(fetchMock.mock.calls[13][1].method).toBe('POST')
    expect(fetchMock.mock.calls[14][0].toString()).toContain('/assistant/admin/dataops/catalog')
    expect(fetchMock.mock.calls[15][0].toString()).toContain('/assistant/admin/dataops/catalog/reload')
    expect(fetchMock.mock.calls[15][1].method).toBe('POST')
    expect(fetchMock.mock.calls[16][0].toString()).toContain('/assistant/admin/dataops/metrics/rebuild')
    expect(fetchMock.mock.calls[16][1].method).toBe('POST')
    expect(fetchMock.mock.calls[17][0].toString()).toContain('/assistant/admin/mcp/governance')
    expect(fetchMock.mock.calls[18][0].toString()).toContain('/assistant/admin/mcp/resources/read')
    expect(fetchMock.mock.calls[18][1].method).toBe('POST')
    expect(fetchMock.mock.calls[19][0].toString()).toContain('/assistant/admin/mcp/prompts/render')
    expect(fetchMock.mock.calls[19][1].method).toBe('POST')
    expect(fetchMock.mock.calls[20][0].toString()).toContain('/assistant/runs/run-9/replay')
    expect(fetchMock.mock.calls[20][1].method).toBe('POST')
    expect(fetchMock.mock.calls[21][0].toString()).toContain('/assistant/evals/rag/run')
    expect(fetchMock.mock.calls[21][1].method).toBe('POST')
    expect(JSON.parse(fetchMock.mock.calls[21][1].body)).toEqual({ limit: 5 })
    expect(fetchMock.mock.calls[22][0].toString()).toContain('/assistant/evals/rag/runs/rag-eval-2')
    expect(fetchMock.mock.calls[23][0].toString()).toContain('/assistant/customer-service/starter-prompts')
    expect(fetchMock.mock.calls[24][0].toString()).toContain('/assistant/customer-service/quick-answer')
    expect(fetchMock.mock.calls[24][1].method).toBe('POST')
    expect(fetchMock.mock.calls[25][0].toString()).toContain('/assistant/customer-service/handoff')
    expect(fetchMock.mock.calls[25][1].method).toBe('POST')
    expect(fetchMock.mock.calls[26][0].toString()).toContain('/assistant/customer-service/work-items/work-item-1')
    expect(fetchMock.mock.calls[27][0].toString()).toContain('/assistant/admin/customer-service/dashboard')
    expect(fetchMock.mock.calls[28][0].toString()).toContain('/assistant/admin/customer-service/top-questions')
    expect(fetchMock.mock.calls[29][0].toString()).toContain('/assistant/admin/customer-service/unresolved-cases')
    expect(fetchMock.mock.calls[30][0].toString()).toContain('/assistant/admin/prompt-versions?promptKey=knowledge.answer')
    expect(fetchMock.mock.calls[31][0].toString()).toContain('/assistant/admin/prompt-versions/release-records?promptKey=knowledge.answer')
    expect(fetchMock.mock.calls[32][0].toString()).toContain('/assistant/admin/prompt-versions')
    expect(fetchMock.mock.calls[32][1].method).toBe('POST')
    expect(fetchMock.mock.calls[33][0].toString()).toContain('/assistant/admin/prompt-versions/release-plan')
    expect(fetchMock.mock.calls[33][1].method).toBe('POST')
    expect(fetchMock.mock.calls[34][0].toString()).toContain('/assistant/admin/prompt-versions/publish')
    expect(fetchMock.mock.calls[35][0].toString()).toContain('/assistant/admin/prompt-versions/rollback')
  })
})
