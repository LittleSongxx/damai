...
describe('api sse helpers', () => {
  ...
  it('calls RAG eval, AIOps, and prompt governance endpoints', async () => {
    ...
    expect(fetchMock.mock.calls[1][0].toString()).toContain('/assistant/admin/rag-eval/bad-cases/bad-1/convert')
    expect(fetchMock.mock.calls[1][1].method).toBe('POST')
    expect(fetchMock.mock.calls[2][0].toString()).toContain('/assistant/admin/rag-eval/bad-cases/bad-1/review')
    expect(fetchMock.mock.calls[2][1].method).toBe('POST')
    expect(fetchMock.mock.calls[3][0].toString()).toContain('/assistant/admin/knowledge/reindex-jobs?taskType=incremental')
    expect(fetchMock.mock.calls[3][1].method).toBe('POST')
    expect(fetchMock.mock.calls[4][0].toString()).toContain('/assistant/admin/knowledge/ingestion/tasks')
    expect(fetchMock.mock.calls[5][0].toString()).toContain('/assistant/admin/ops/providers')
    expect(fetchMock.mock.calls[6][0].toString()).toContain('/assistant/admin/ops/runbooks')
    expect(fetchMock.mock.calls[7][0].toString()).toContain('/assistant/admin/ops/rca-evidence')
    expect(fetchMock.mock.calls[7][1].method).toBe('POST')
    expect(fetchMock.mock.calls[8][0].toString()).toContain('/assistant/admin/dataops/catalog')
    expect(fetchMock.mock.calls[9][0].toString()).toContain('/assistant/admin/dataops/catalog/reload')
    expect(fetchMock.mock.calls[9][1].method).toBe('POST')
    expect(fetchMock.mock.calls[10][0].toString()).toContain('/assistant/admin/dataops/metrics/rebuild')
    expect(fetchMock.mock.calls[10][1].method).toBe('POST')
    expect(fetchMock.mock.calls[11][0].toString()).toContain('/assistant/admin/mcp/governance')
    expect(fetchMock.mock.calls[12][0].toString()).toContain('/assistant/admin/mcp/resources/read')
    expect(fetchMock.mock.calls[12][1].method).toBe('POST')
    expect(fetchMock.mock.calls[13][0].toString()).toContain('/assistant/admin/mcp/prompts/render')
    expect(fetchMock.mock.calls[13][1].method).toBe('POST')
    expect(fetchMock.mock.calls[14][0].toString()).toContain('/assistant/runs/run-9/replay')
    expect(fetchMock.mock.calls[14][1].method).toBe('POST')
    expect(fetchMock.mock.calls[15][0].toString()).toContain('/assistant/evals/rag/run')
    expect(fetchMock.mock.calls[15][1].method).toBe('POST')
    expect(JSON.parse(fetchMock.mock.calls[15][1].body)).toEqual({ limit: 5 })
    expect(fetchMock.mock.calls[16][0].toString()).toContain('/assistant/evals/rag/runs/rag-eval-2')
    expect(fetchMock.mock.calls[17][0].toString()).toContain('/assistant/customer-service/starter-prompts')
    expect(fetchMock.mock.calls[18][0].toString()).toContain('/assistant/customer-service/quick-answer')
    expect(fetchMock.mock.calls[18][1].method).toBe('POST')
    expect(fetchMock.mock.calls[19][0].toString()).toContain('/assistant/customer-service/handoff')
    expect(fetchMock.mock.calls[19][1].method).toBe('POST')
    expect(fetchMock.mock.calls[20][0].toString()).toContain('/assistant/customer-service/work-items/work-item-1')
    expect(fetchMock.mock.calls[21][0].toString()).toContain('/assistant/admin/customer-service/dashboard')
    expect(fetchMock.mock.calls[22][0].toString()).toContain('/assistant/admin/customer-service/top-questions')
    expect(fetchMock.mock.calls[23][0].toString()).toContain('/assistant/admin/customer-service/unresolved-cases')
    expect(fetchMock.mock.calls[24][0].toString()).toContain('/assistant/admin/prompt-versions?promptKey=knowledge.answer')
    expect(fetchMock.mock.calls[25][0].toString()).toContain('/assistant/admin/prompt-versions/release-records?promptKey=knowledge.answer')
    expect(fetchMock.mock.calls[26][0].toString()).toContain('/assistant/admin/prompt-versions')
    expect(fetchMock.mock.calls[26][1].method).toBe('POST')
    expect(fetchMock.mock.calls[27][0].toString()).toContain('/assistant/admin/prompt-versions/release-plan')
    expect(fetchMock.mock.calls[27][1].method).toBe('POST')
    expect(fetchMock.mock.calls[28][0].toString()).toContain('/assistant/admin/prompt-versions/publish')
    expect(fetchMock.mock.calls[29][0].toString()).toContain('/assistant/admin/prompt-versions/rollback')
  })
})
